...
import NoAvatar from '../assets/icons/avatar-off.svg';
  ...
  return (
    <>
      <Control>
        ...
        <Circle onClick={handleParticipantsListToggle}>
          <Image src={participantsList ? Avatar : NoAvatar} />
        </Circle>
        <Circle endCall onClick={handleLogout}>
          <Image src={End} />
        </Circle>
      </Control>
    </>
